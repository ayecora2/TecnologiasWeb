						...
						<div id="my-card" class="card card-rotating text-center">
							...
							<div class="face front">
								<div class="card-body">
									...
									<form action="UserLoginRequest" method="get">
										...
										<div class="md-form">
											<i class="fas grey-text d-flex"></i> <input type="password"
												id="pass" name="pass" class="form-control"> <label
												for="password" class="d-flex">Su contraseña</label>
										</div>
							...
							<div class="face back">
								<div class="card-body">
									...
									<form class="form-horizontal" action="UserCreateRequest"
										method="get">
										<div class="md-form">
											<i class="fas grey-text d-flex"></i> <input
										...
										<div class="md-form">
											<i class="fas grey-text d-flex"></i> <input type="text"
												pattern="[A-Za-z]{1,25}" maxlength="25" id="apellido"
												name="apellido" class="form-control" required> <label
												for="Apellido" class="d-flex">Apellido/s</label>
										</div>
										<div class="md-form">
										...
										<div class="md-form">
											<i class="fas grey-text d-flex"></i> <input type="text"
												pattern="[0-9]{9,12}" maxlength="12" id="telefono"
												name="telefono" class="form-control" required> <label
												for="Telefono" class="d-flex">Teléfono de contacto</label>
										</div>
										<div class="md-form">
											<i class="fas grey-text d-flex"></i> <input type="password"
												maxlength="8" id="password" name="password"
												class="form-control" required> <label for="pass"
												class="d-flex">Escriba una contraseña</label>
										</div>
										<div class="md-form">
											<i class="fas grey-text d-flex"></i> <input type="text"
												maxlength="20" id="ciudad" name="ciudad"
												class="form-control" required> <label for="Ciudad"
												class="d-flex">Ciudad de residencia</label>
										</div>
										<div class="md-form">
											<i class="fas grey-text d-flex"></i> <input type="text"
												maxlength="100" id="direccion" name="direccion"
												class="form-control" required> <label
												for="Direccion" class="d-flex">Su dirección</label>
										</div>
										<div class="md-form">
											<i class="fas grey-text d-flex"></i> <input type="text"
												size="6" pattern="[0-9]{5}" maxlength="5" id="CP" name="CP"
												class="form-control" required> <label for="CP"
												class="d-flex">Código postal</label>
										</div>
										<div class="md-form">
											<i class="fas grey-text d-flex"></i> <input type="hidden"
												readonly id="userType_Id" name="userType_Id"
